...
<html lang="en">
    ...
    <script src="https://kit.fontawesome.com/89490613c7.js" crossorigin="anonymous"></script>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="main__style.css" />
    </head>
    <body>
        <!-- main -->
        <main> 
            ...
            <section id="home" class="max-container">
                <div class="home__container">
                    <section class="home__post">
                        ...
                        <img class="home__logo" src="image/beforelogocolor.png" alt="logo" />
                    ...
                    <section class="home__img">
                        <img class="home__sideImg" src="image/sideImg.png" alt="sideImg" />
                    </section>
